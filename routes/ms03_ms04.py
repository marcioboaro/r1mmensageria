...
#@ms03_ms04.post("/ms03", tags=["ms04"], response_model=MS04, description="Consulta catalogo Lockers")
@ms03_ms04.post("/ms03", tags=["ms04"], description="Consulta catalogo Lockers")
def ms03(ms03: MS03, public_id=Depends(auth_handler.auth_wrapper)):
    ...
    print('conn.execute(command_sql)')
    where = 0
    if ms03.ID_de_Referencia is None:
